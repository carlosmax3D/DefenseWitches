...
public class IabHelper {
    ...
    public boolean handleActivityResult(int r13, int r14, android.content.Intent r15) {
        ...
        L_0x0006:
            ...
            r12.logError(r8)
            plugin.google.iap.v3.util.IabResult r6 = new plugin.google.iap.v3.util.IabResult
            r8 = -1002(0xfffffffffffffc16, float:NaN)
            java.lang.String r9 = "Null data in IAB result"
            r6.<init>(r8, r9)
            plugin.google.iap.v3.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
        ...
        L_0x00df:
            r2 = 0
            plugin.google.iap.v3.util.Purchase r3 = new plugin.google.iap.v3.util.Purchase     // Catch:{ JSONException -> 0x0148 }
            java.lang.String r8 = r12.mPurchasingItemType     // Catch:{ JSONException -> 0x0148 }
            r3.<init>(r8, r4, r0)     // Catch:{ JSONException -> 0x0148 }
            java.lang.String r7 = r3.getSku()     // Catch:{ JSONException -> 0x0210 }
            java.lang.String r8 = r12.mSignatureBase64     // Catch:{ JSONException -> 0x0210 }
            boolean r8 = plugin.google.iap.v3.util.Security.verifyPurchase(r8, r4, r0)     // Catch:{ JSONException -> 0x0210 }
            if (r8 != 0) goto L_0x012f
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ JSONException -> 0x0210 }
            r8.<init>()     // Catch:{ JSONException -> 0x0210 }
            java.lang.String r9 = "Purchase signature verification FAILED for sku "
            java.lang.StringBuilder r8 = r8.append(r9)     // Catch:{ JSONException -> 0x0210 }
            java.lang.StringBuilder r8 = r8.append(r7)     // Catch:{ JSONException -> 0x0210 }
            java.lang.String r8 = r8.toString()     // Catch:{ JSONException -> 0x0210 }
            r12.logError(r8)     // Catch:{ JSONException -> 0x0210 }
            plugin.google.iap.v3.util.IabResult r6 = new plugin.google.iap.v3.util.IabResult     // Catch:{ JSONException -> 0x0210 }
            r8 = -1003(0xfffffffffffffc15, float:NaN)
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ JSONException -> 0x0210 }
            r9.<init>()     // Catch:{ JSONException -> 0x0210 }
            java.lang.String r10 = "Signature verification failed for sku "
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ JSONException -> 0x0210 }
            java.lang.StringBuilder r9 = r9.append(r7)     // Catch:{ JSONException -> 0x0210 }
            java.lang.String r9 = r9.toString()     // Catch:{ JSONException -> 0x0210 }
            r6.<init>(r8, r9)     // Catch:{ JSONException -> 0x0210 }
            plugin.google.iap.v3.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener     // Catch:{ JSONException -> 0x0210 }
            if (r8 == 0) goto L_0x012c
            plugin.google.iap.v3.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener     // Catch:{ JSONException -> 0x0210 }
            r8.onIabPurchaseFinished(r6, r3)     // Catch:{ JSONException -> 0x0210 }
        L_0x012c:
            r8 = 1
            goto L_0x0005
        L_0x012f:
            java.lang.String r8 = "Purchase signature successfully verified."
            r12.logDebug(r8)     // Catch:{ JSONException -> 0x0210 }
            plugin.google.iap.v3.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
            if (r8 == 0) goto L_0x0145
            plugin.google.iap.v3.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
            plugin.google.iap.v3.util.IabResult r9 = new plugin.google.iap.v3.util.IabResult
            r10 = 0
        ...
        L_0x0196:
            ...
            plugin.google.iap.v3.util.IabResult r6 = new plugin.google.iap.v3.util.IabResult
            r8 = 7
            java.lang.String r9 = "Item already owned."
            r6.<init>(r8, r9)
        L_0x01bd:
            plugin.google.iap.v3.util.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
            if (r8 == 0) goto L_0x0145
        ...
        L_0x0210:
            ...
            goto L_0x0149
        */
        throw new UnsupportedOperationException("Method not decompiled: plugin.google.iap.v3.util.IabHelper.handleActivityResult(int, int, android.content.Intent):boolean");
    }
    ...
    public void launchPurchaseFlow(Activity activity, String str, String str2, int i, OnIabPurchaseFinishedListener onIabPurchaseFinishedListener, String str3) {
        ...
        if (str2.equals("subs") && !this.mSubscriptionsSupported) {
            ...
            IabResult iabResult2 = new IabResult(-1000, "Improper initialization.");
            if (onIabPurchaseFinishedListener != null) {
            ...
            try {
                ...
                if (onIabPurchaseFinishedListener != null) {
                    onIabPurchaseFinishedListener.onIabPurchaseFinished(iabResult5, (Purchase) null);
                }
            }
        }
    }
    ...
    public Inventory queryInventory(boolean z, Set<String> set) throws IabException {
        return queryInventory(z, set, (Set<String>) null);
    }

    public Inventory queryInventory(boolean z, Set<String> set, Set<String> set2) throws IabException {
        int querySkuDetails;
        checkNotDisposed();
        ...
        try {
            ...
            if (z) {
                int querySkuDetails2 = querySkuDetails("inapp", inventory, set);
            ...
            if (this.mSubscriptionsSupported) {
                ...
                } else if (z && (querySkuDetails = querySkuDetails("subs", inventory, set2)) != 0) {
    ...
    public void queryInventoryAsync(QueryInventoryFinishedListener queryInventoryFinishedListener) {
        queryInventoryAsync(true, (Set<String>) null, (Set<String>) null, queryInventoryFinishedListener);
    }

    public void queryInventoryAsync(boolean z, Set<String> set, Set<String> set2, QueryInventoryFinishedListener queryInventoryFinishedListener) {
        checkNotDisposed();
        checkSetupDone("queryInventory");
        final boolean z2 = z;
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    inventory = IabHelper.this.queryInventory(z2, set3, set4);
                } catch (IabException e) {
    ...
    public void queryInventoryAsync(boolean z, QueryInventoryFinishedListener queryInventoryFinishedListener) {
        queryInventoryAsync(z, (Set<String>) null, (Set<String>) null, queryInventoryFinishedListener);
    }
    ...
    /* access modifiers changed from: package-private */
    public int querySkuDetails(String str, Inventory inventory, Set<String> set) throws RemoteException, JSONException {
    ...
    public void startSetup(final OnIabSetupFinishedListener onIabSetupFinishedListener) {
        ...
        if (this.mContext != null && this.mContext.getPackageManager() != null && !this.mContext.getPackageManager().queryIntentServices(intent, 0).isEmpty()) {
