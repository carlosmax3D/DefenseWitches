...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec((int) (((float) size) * 0.8f), ExploreByTouchHelper.INVALID_ID);
    ...
    public void updateText(int i, PagerAdapter pagerAdapter) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec((int) (((float) width) * 0.8f), ExploreByTouchHelper.INVALID_ID);
    ...
    public void updateTextPositions(int i, float f, boolean z) {
        ...
        int measuredHeight = i10 + this.mPrevText.getMeasuredHeight();
        int measuredHeight2 = i11 + this.mCurrText.getMeasuredHeight();
        int max2 = Math.max(Math.max(measuredHeight, measuredHeight2), i12 + this.mNextText.getMeasuredHeight());
