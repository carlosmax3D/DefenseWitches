...
public interface bt extends IInterface {
    ...
    public static abstract class a extends Binder implements bt {
        ...
        private static class C0018a implements bt {
            private IBinder dU;
        ...
        public static bt n(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bt)) ? new C0018a(iBinder) : (bt) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder a = a(b.a.E(parcel.readStrongBinder()));
