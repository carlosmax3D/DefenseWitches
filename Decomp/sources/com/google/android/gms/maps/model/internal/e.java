...
public interface e extends IInterface {
    ...
    public static abstract class a extends Binder implements e {
        ...
        private static class C0074a implements e {
            private IBinder dU;
        ...
        public static e an(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof e)) ? new C0074a(iBinder) : (e) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    boolean a = a(an(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    if (a) {
                        z = true;
                    }
