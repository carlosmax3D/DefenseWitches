...
public interface k extends IInterface {
    ...
    public static abstract class a extends Binder implements k {
        ...
        private static class C0063a implements k {
            private IBinder dU;
        ...
        public static k ac(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof k)) ? new C0063a(iBinder) : (k) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    boolean a = a(d.a.am(parcel.readStrongBinder()));
