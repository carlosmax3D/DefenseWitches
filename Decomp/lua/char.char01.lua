...
if _G.GameMode == _G.GameModeEvo then
  r0_0 = require("evo.char_tbl.tbl_c01_daisy").CreateTable()
end
local r1_0 = {
  "c01_daisy01_0_0",
  "c01_daisy01_1_0",
...
local r3_0 = {}
for r7_0 = 1, 8, 1 do
  table.insert(r3_0, require(string.format("char.c01.c01_daisy%02d", r7_0)))
end
local r4_0 = {
  {
    0,
...
local function r6_0(r0_2, r1_2, r2_2, r3_2)
  ...
  local r7_2 = display.newImage("data/game/afx01_energyball.png")
