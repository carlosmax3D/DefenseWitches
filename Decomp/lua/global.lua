...
local r0_0 = _G
local r1_0 = _G.SystemLanguage
if r1_0 ~= "ja" then
  r1_0 = _G.SystemLanguage
  if r1_0 ~= "1041" then
    r1_0 = _G.SystemLanguage
    if r1_0 ~= "ja-JP" then
      r1_0 = _G.SystemLanguage
      if r1_0 == "日本語" then
        ...
        goto label_151	-- block#20 is visited secondly
      end
    end
  end
else
  goto label_148	-- block#19 is visited secondly
end
r0_0.UILanguage = r1_0
_G.GameModeNormal = 1
_G.GameModeEvo = 2
