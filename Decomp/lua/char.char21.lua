...
if _G.GameMode == _G.GameModeEvo then
  r1_0 = require("evo.char_tbl.tbl_c21_jill").CreateTable()
end
...
local r4_0 = false
local r5_0 = _G.CharaParam[r2_0.CharId.Jill][1]
local r6_0 = _G.CharaParam[r2_0.CharId.Jill][2][1] * 0.01
local r7_0 = _G.CharaParam[r2_0.CharId.Jill][3][1] * 0.0001
local r8_0 = _G.CharaParam[r2_0.CharId.Jill][4][1]
local r9_0 = 3
local r10_0 = require("char.c21.t01.c21_jill01")
local r11_0 = require("char.c21.t01.afx21_poison")
local r12_0 = "/jill/t01"
local function r13_0(r0_1, r1_1)
  ...
  if r2_1 > 0 then
    for r13_1, r14_1 in pairs(_G.Enemys) do
      if r14_1.poison_effective.enabled == false and r14_1.attack[2] == false and 0 < r2_1 then
