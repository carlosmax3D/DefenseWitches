...
local r0_0 = "adfurikunIcon.txt"
local r1_0 = "_tmp_adfurikun_icon"
local r2_0 = _G.VERSION_MY_AD_URLSTR
local r3_0 = true
local function r4_0(r0_1)
  -- line: [13, 26] id: 1
  DebugPrint("ADS adfurikunIcon:HttpGetListener")
  if r0_1.isError then
    DebugPrint("ADS adfurikunIcon:Network error - http GET failed")
  elseif r0_1.status == 200 then
    DebugPrint("ADS adfurikunIcon:HTTP GET OK. " .. r0_1.status)
    r3_0 = true
  else
    DebugPrint("ADS adfurikunIcon:HTTP GET NG. " .. r0_1.status)
  end
end
function GetLastRes()
  -- line: [28, 35] id: 2
