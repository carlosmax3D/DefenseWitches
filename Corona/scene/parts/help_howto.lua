...
local function r10_0(r0_8)
  ...
  local function r7_8(r0_9)
    ...
    if r1_9 >= 1 then
      ...
      r3_9 = r1_9 >= 1	-- block#2 is visited secondly
    end
    r2_9(r3_9)
    sound.PlaySE(1)
    r2_9 = r0_0.ViewHelp
...
local function r12_0(r0_10)
  ...
  local function r7_10(r0_11)
    ...
    if r1_11 >= 1 then
      ...
      r1_11 = r1_11 >= 1	-- block#2 is visited secondly
    end
    r2_11(r3_11)
    sound.PlaySE(1)
    r2_11 = r0_0.ViewHelp
...
local function r14_0(r0_12)
  ...
  local function r7_12(r0_13)
    ...
    if r1_13 >= 1 then
      ...
      r3_13 = r1_13 >= 1	-- block#2 is visited secondly
    end
    r2_13(r3_13)
    sound.PlaySE(1)
    r2_13 = r0_0.ViewHelp
...
local function r16_0(r0_14)
  ...
  local function r12_14(r0_15)
    ...
    if r1_15 >= 1 then
      ...
      r3_15 = r1_15 >= 1	-- block#2 is visited secondly
    end
    r2_15(r3_15)
    sound.PlaySE(1)
    r2_15 = r0_0.ViewHelp
