...
local function r0_0(r0_1, r1_1, r2_1)
  ...
  if r1_1.angle[r2_1] ~= 0 then
    ...
    r5_1.rotation = r9_1 - _G.math.floor(r9_1 / 360) * 360
  else
    r5_1.rotation = 0
  end
...
local function r2_0(r0_3, r1_3, r2_3)
  ...
  for r8_3, r9_3 in _G.pairs(r0_3.layers) do
    r9_3.spr.x = r1_3
    r9_3.spr.y = r2_3
  end
end
local function r3_0(r0_4, r1_4, r2_4)
  ...
  for r8_4, r9_4 in _G.pairs(r0_4.pack) do
    r2_0(r9_4, r1_4, r2_4)
  end
end
local function r4_0(r0_5, r1_5, r2_5, r3_5, r4_5)
  -- line: [153, 211] id: 5
  local r5_5 = _G.display.newGroup()
  local r6_5 = {}
  local r7_5 = nil
  local r8_5 = nil
  local r9_5 = nil
  local r10_5 = nil
  for r14_5, r15_5 in _G.pairs(r0_5) do
    r8_5 = {}
    r9_5 = r3_5 .. "/" .. r15_5.name
    r10_5 = _G.display.newImage(r9_5)
    r10_5:setReferencePoint(_G.display.CenterReferencePoint)
    r10_5.x = r1_5
    r10_5.y = r2_5
  ...
  r11_5.ev = _G.events.Register(r1_0, r11_5, r4_5, false)
  return r11_5
end
return {
  ...
  RegisterCallback = function(r0_7)
    -- line: [218, 220] id: 7
    r0_7.ev = _G.events.Register(r1_0, r0_7, 0)
  end,
  ReplaceSprite = function(r0_8, r1_8, r2_8)
    -- line: [230, 258] id: 8
    for r13_8, r14_8 in _G.pairs(r0_8.layers) do
      if _G.type(r14_8) == "table" and r14_8.spr ~= nil then
        local r6_8 = r2_8[r13_8]
        if r6_8 ~= nil then
          local r7_8 = r14_8.spr.x
          local r8_8 = r14_8.spr.y
          local r9_8 = r14_8.spr.isVisible
          _G.display.remove(r14_8.spr)
          r14_8.spr = nil
          r14_8.spr = _G.display.newImage(r1_8 .. "/" .. r6_8.name)
          r14_8.spr:setReferencePoint(_G.display.CenterReferencePoint)
          r14_8.spr.x = r7_8
          r14_8.spr.y = r8_8
  ...
  Remove = function(r0_9)
    -- line: [260, 278] id: 9
    _G.assert(r0_9, _G.debug.traceback())
    if r0_9.name == "PackAnimation" then
      for r4_9 = 1, r0_9.nr, 1 do
        for r8_9, r9_9 in _G.pairs(r0_9.pack[r4_9].layers) do
          r9_9.spr.isVisible = false
          _G.display.remove(r9_9.spr)
        end
        _G.display.remove(r0_9.pack[r4_9].sprite)
      end
    else
      for r4_9, r5_9 in _G.pairs(r0_9.layers) do
        r5_9.spr.isVisible = false
        _G.display.remove(r5_9.spr)
      end
      _G.display.remove(r0_9.sprite)
    end
    _G.events.Delete(r0_9.ev)
  end,
  Init = function()
    -- line: [280, 281] id: 10
  end,
  ...
  Show = function(r0_12, r1_12, r2_12)
    -- line: [290, 368] id: 12
    _G.assert(r0_12, _G.debug.traceback())
    local function r3_12(r0_13)
      -- line: [293, 304] id: 13
      if r0_13 == nil or r2_12 == nil then
        return 
      end
      for r4_13, r5_13 in _G.pairs(r2_12) do
        if r4_13 == "timer" then
          r0_13.timer = r5_13
        end
      end
    ...
    if r0_12.name == "PackAnimation" then
      r0_12.show = r1_12
      local r4_12 = _G.math.floor(r0_12.timer)
      for r8_12 = 1, r0_12.nr, 1 do
        if r8_12 == r0_12.vect then
          if r1_12 then
            local r9_12 = nil
            local r10_12 = nil
            for r14_12, r15_12 in _G.pairs(r0_12.pack[r8_12].layers) do
              r9_12 = r15_12.start
              r10_12 = r15_12.stop
          ...
          for r12_12, r13_12 in _G.pairs(r0_12.pack[r8_12].layers) do
      ...
      if r1_12 then
        local r4_12 = nil
        local r5_12 = nil
        local r6_12 = _G.math.floor(r0_12.timer)
        for r10_12, r11_12 in _G.pairs(r0_12.layers) do
          r4_12 = r11_12.start
          r5_12 = r11_12.stop
        ...
        for r7_12, r8_12 in _G.pairs(r0_12.layers) do
    ...
    r0_12.playing = r1_12
    if r2_12 then
      for r7_12, r8_12 in _G.pairs(r2_12) do
        if r7_12 == "timer" then
          r0_12.timer = r8_12
  ...
  GetTimer = function(r0_14)
    -- line: [370, 373] id: 14
    _G.assert(r0_14, _G.debug.traceback())
    return r0_14.timer
  end,
  GetSprite = function(r0_15)
    -- line: [375, 378] id: 15
    _G.assert(r0_15, _G.debug.traceback())
    return r0_15.sprite
  end,
  ...
  Pause = function(r0_17, r1_17)
    -- line: [385, 390] id: 17
    _G.assert(r0_17, _G.debug.traceback())
    r0_17.pause = r1_17
    return r0_17.pause
  end,
  GetPos = function(r0_18)
    -- line: [392, 395] id: 18
    _G.assert(r0_18, _G.debug.traceback())
    return r0_18.xy
  end,
  ...
  GetPause = function(r0_24)
    -- line: [427, 430] id: 24
    _G.assert(r0_24, _G.debug.traceback())
    return r0_24.pause
  end,
  RegisterTrigger = function(r0_25, r1_25, r2_25, r3_25)
    -- line: [432, 436] id: 25
    _G.assert(r0_25, _G.debug.traceback())
    r0_25.trigger = {
      r1_25,
      r2_25
    }
  ...
  RegisterTrigger2 = function(r0_26, r1_26, r2_26, r3_26)
    -- line: [438, 442] id: 26
    _G.assert(r0_26, _G.debug.traceback())
    r0_26.trigger2 = {
      r1_26,
      r2_26
    }
  ...
  Pack = function(...)
    ...
    for r6_35, r7_35 in _G.pairs(r1_35.pack) do
      _G.events.Delete(r7_35.ev)
    end
    r1_35.ev = _G.events.Register(r1_0, r1_35, 0, false)
    return r1_35
  end,
  ChangeVect = function(r0_36, r1_36)
    -- line: [547, 581] id: 36
    _G.assert(r0_36, _G.debug.traceback())
    local r2_36 = _G.assert
    local r3_36 = r0_36.name == "PackAnimation"
    r2_36(r3_36, _G.debug.traceback())
    r2_36 = _G.assert
    if r1_36 >= 1 then
      r3_36 = r1_36 <= r0_36.nr
    else
      r3_36 = r1_36 >= 1	-- block#5 is visited secondly
    end
    r2_36(r3_36)
    ...
    r0_36.vect = r1_36
    r3_36 = r0_36.show
    local r4_36 = _G.math.floor(r0_36.timer)
    for r8_36 = 1, r0_36.nr, 1 do
      if r8_36 == r1_36 then
        if r3_36 then
          local r9_36 = nil
          local r10_36 = nil
          for r14_36, r15_36 in _G.pairs(r0_36.pack[r8_36].layers) do
            r9_36 = r15_36.start
            r10_36 = r15_36.stop
        ...
        for r12_36, r13_36 in _G.pairs(r0_36.pack[r8_36].layers) do
  ...
  SetTimer = function(r0_37, r1_37)
    -- line: [583, 586] id: 37
    _G.assert(r0_37, _G.debug.traceback())
    r0_37.timer = r1_37
  end,
