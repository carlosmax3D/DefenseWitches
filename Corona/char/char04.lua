...
if _G.GameMode == _G.GameModeEvo then
  r0_0 = require("evo.char_tbl.tbl_c04_nicola").CreateTable()
end
local r1_0 = {
  "c04_nicola01_0_0",
  "c04_nicola01_1_0",
...
local r3_0 = {}
for r7_0 = 1, 8, 1 do
  table.insert(r3_0, require(string.format("char.c04.c04_nicola%02d", r7_0)))
end
local r4_0 = {
  {
    0,
...
local r5_0 = _G.CharaParam[4][1]
local r6_0 = _G.CharaParam[4][2][1]
local r7_0 = _G.CharaParam[4][3][1] / 100
local function r8_0(r0_1, r1_1, r2_1)
  ...
  if not r1_1.hit then
    ...
    local r21_1 = r3_1.power[r19_1]
    local r22_1 = r3_1.buff_power
    local r23_1 = r20_1.attr
    local r24_1 = nil	-- notice: implicit variable refs by block#[8, 13]
    if r23_1 ~= 3 then
      r24_1 = r23_1 == 4
    else
      r24_1 =	r23_1 ~= 3 -- block#7 is visited secondly
    end
    if r24_1 then
      r21_1 = r21_1 * r7_0
    end
    ...
    r14_1 = false
    if _G.GameMode == _G.GameModeEvo then
      r1_1.target.func.hit(r20_1, r21_1, r3_1)
    else
      r1_1.target.func.hit(r20_1, r21_1)
    end
    if not r24_1 then
      r1_1.target.func.freeze(r20_1, r5_0[r19_1], r6_0)
    end
  end
  if not r14_1 then
...
local function r9_0(r0_2, r1_2, r2_2, r3_2)
  ...
  local r7_2 = display.newImage("data/game/afx04_icegrains.png")
...
local function r13_0()
  ...
  local r0_6 = db.CountAchievement(_G.UserID, 10)
  local r1_6 = nil
  local r2_6 = nil
  if r0_6 <= 10 then
...
return setmetatable({
  ...
  check_upgrade_ok_achievement = function(r0_7)
    -- line: [233, 237] id: 7
    if r0_7.level == 3 then
      r13_0()
    end
  end,
}, {
