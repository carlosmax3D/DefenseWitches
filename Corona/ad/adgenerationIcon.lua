...
local r0_0 = "adgenerationIcon.txt"
local r1_0 = "_tmp_adgeneration_icon"
local r2_0 = _G.VERSION_MY_AD_URLSTR
local r3_0 = true
local function r4_0(r0_1)
  -- line: [13, 26] id: 1
  DebugPrint("ADS adgenerationIcon:HttpGetListener")
  if r0_1.isError then
    DebugPrint("ADS:Network error - http GET failed")
  elseif r0_1.status == 200 then
    DebugPrint("ADS adgenerationIcon:HTTP GET OK. " .. r0_1.status)
    r3_0 = true
  else
    DebugPrint("ADS adgenerationIcon:HTTP GET NG. " .. r0_1.status)
  end
end
function GetLastRes()
  -- line: [28, 35] id: 2
