...
val coronaAppPackage = project.findProperty("coronaAppPackage") as? String ?: "jp.newgate.game.android.dw"
...
fun checkCoronaNativeInstallation() {
    if (file("$nativeDir/Corona/android/resource/android-template.zip").exists())
        return
    println("$nativeDir/Corona/android/resource/android-template.zip")
    if (windows) {
...
dependencies {
    ...
    implementation("com.socdm.d.adgeneration:adg:2.29.1")
/*    implementation("jp.fluct:FluctSDK:9.13.7")
    ...
    implementation("com.threatmetrix.TrustDefender:TrustDefender:5.0-96")
